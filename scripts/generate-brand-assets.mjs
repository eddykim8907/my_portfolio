...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630" role="img" aria-label="Eddy Portfolio">
  <defs>
  ...
  <text x="120" y="280" fill="#ffffff" font-family="system-ui, sans-serif" font-size="64" font-weight="700">Eddy</text>
  <text x="120" y="350" fill="#d4d4d4" font-family="system-ui, sans-serif" font-size="36">Full-stack developer</text>
...
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" role="img" aria-label="Eddy">
...
<svg xmlns="http://www.w3.org/2000/svg" width="180" height="180" viewBox="0 0 180 180" role="img" aria-label="Eddy">
